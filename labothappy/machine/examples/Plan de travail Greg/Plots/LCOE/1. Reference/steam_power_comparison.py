# -*- coding: utf-8 -*-
"""
CAPEX breakdown + LCOE vs turbine size — Steam Rankine
...
LCOE_vals = np.array([98.11, 68.61, 62.95, 60.68])

# CAPEX in M€
solar_field  = np.array([145.793, 126.610, 123.585, 122.505])
storage      = np.array([110.014,  78.412,  75.579,  75.535])
power_block  = np.array([175.775,  62.498,  39.061,  26.561])
piping       = np.array([ 10.403,  14.381,  16.674,  18.237])
hx           = np.array([ 67.360,  38.229,  33.558,  26.339])
elec_civil   = np.array([  6.740,   4.859,   4.699,   4.685])
...
fig.tight_layout()
path = os.path.join(SAVE_DIR, "fig_LCOE_turbine_size_steam.pdf")
